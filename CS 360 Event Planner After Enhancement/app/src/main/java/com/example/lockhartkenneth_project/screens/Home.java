...
import com.example.lockhartkenneth_project.fragments.DailyPlanner;
...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // fragment container
        FragmentContainerView fragmentContainerView = findViewById(R.id.containerView);
        ...
        menuButton.setOnClickListener(v -> sideMenu.setVisibility(View.VISIBLE));
    ...
    private void setupBottomMenuActions() {
        bottomMenu.setOnItemSelectedListener(item -> {
            ...
            }else if (item.getItemId() == R.id.bottomDailyPlanner){
                // If the calander button is clicked switch fragments to the calander events fragment
                fragmentManager.beginTransaction().replace(R.id.containerView, DailyPlanner.class, null).commit();
            }
            return true;
        });
    }
