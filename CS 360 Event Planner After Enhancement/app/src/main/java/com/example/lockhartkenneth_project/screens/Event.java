...
public class Event extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setOnClickListener(v -> {
            ...
            if (!name.getText().equals("") && !desc.getText().equals("") && !startDate.getText().equals("") && !endDate.getText().equals("")){
                @SuppressLint("SimpleDateFormat") SimpleDateFormat formatter = new SimpleDateFormat("MM-dd-yyyy hh:mma"); // Date and time format
                try {
    ...
    private void setReminderTimer(String eventName, String eventDesc, String eventTime) {
        ...
        @SuppressLint("SimpleDateFormat") DateFormat format = new SimpleDateFormat("MM-dd-yyyy hh:mma"); // Date format
        try{
