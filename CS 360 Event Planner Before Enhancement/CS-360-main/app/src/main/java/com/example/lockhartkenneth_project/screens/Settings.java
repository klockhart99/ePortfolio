...
public class Settings extends AppCompatActivity {
    ...
    private Button deleteAccount, returnHome, SMS; // Button fields
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        returnHome = findViewById(R.id.returnToHome);
        ...
        SMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(Settings.this, android.Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED) {
                } else {
