...
public class CustomAdaptor extends RecyclerView.Adapter<CustomAdaptor.CustomViewHolder>{
    ...
    private ArrayList eventIds, evenntTitles, eventsDescs, eventsStartDates, eventsEndDates;
    ...
    public CustomAdaptor(Fragment fragment, Context context,
                         ...
                         ArrayList eventDesc,
                         ArrayList eventStartDate,
                         ArrayList eventEndDate){
        ...
        this.eventsEndDates = eventEndDate;
