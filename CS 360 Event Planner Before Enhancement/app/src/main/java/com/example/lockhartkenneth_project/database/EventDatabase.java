...
public class EventDatabase extends SQLiteOpenHelper {
    ...
    public Cursor getEventData(int rowId){
        ...
        Cursor cursor = db.rawQuery(query, new String[] {String.valueOf(rowId)}); // Run the query
        return cursor; // Return query result
    }
    ...
    public Cursor getAllEventsForLoggedInUser() {
        ...
        Cursor cursor = db.rawQuery(q, new String[]{Main.usernameLoggedIn}); // run query
        return cursor; // Return query result
    }
